...
`genes` is a data matrix containing the informations for each tissue-restricted gene (3.433 genes in total). The rows correspond to genes while the columns correspond to their related informations.

```{r}
load("~/projects/ector/data/ector_tissue_specific_genes.RData")
