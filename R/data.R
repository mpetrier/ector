#' Tissue restricted genes data frame 
#'
#' The `ector_tissue_restricted_genes` data frame describes tissue-restricted genes. 
...
#' Tissue restricted genes are determined using threshold algorithme [ref. EpiMed]. ons.
#'
#' @format A data frame with 3433 rows and 7 columns
#' @source \url{http://epimed.univ-grenoble-alpes.fr/database}
"ector_tissue_restricted_genes"
